...
extern const u8 gSpeciesNamesLiteral[][POKEMON_NAME_LENGTH + 1];
extern const u8 gSpeciesNamesTranslit[][POKEMON_NAME_LENGTH + 1];
extern const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1];

const u8 (*GetSpeciesNamesArray(void))[POKEMON_NAME_LENGTH + 1];

#define gSpeciesNames (GetSpeciesNamesArray())
