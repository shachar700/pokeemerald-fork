...
static void UNUSED UnusedDrawTextWindow(const u8 *string, void *dst, u16 offset, u8 bgColor, u8 fgColor, u8 shadowColor)
{
    ...
    AddTextPrinterParameterized4WithRTL(windowId, FONT_NORMAL, 0, 2, 0, 0, txtColor, TEXT_SKIP_DRAW, string, TRUE);
...
static void ChooseBoxMenu_PrintInfo(void)
{
    ...
    AddTextPrinterParameterized3WithRTL(windowId, FONT_NORMAL, center, 1, sChooseBoxMenu_TextColors, TEXT_SKIP_DRAW, boxName, TRUE);
...
static void PrintDisplayMonInfo(void)
{
    ...
    if (sStorage->boxOption != OPTION_MOVE_ITEMS)
    {
        AddTextPrinterParameterizedWithRTL(WIN_DISPLAY_INFO, FONT_NORMAL, sStorage->displayMonNameText, 6, 0, TEXT_SKIP_DRAW, NULL, TRUE);
        AddTextPrinterParameterizedWithRTL(WIN_DISPLAY_INFO, FONT_SHORT, sStorage->displayMonSpeciesName, 6, 15, TEXT_SKIP_DRAW, NULL, TRUE);
        AddTextPrinterParameterizedWithRTL(WIN_DISPLAY_INFO, FONT_SHORT, sStorage->displayMonGenderLvlText, 10, 29, TEXT_SKIP_DRAW, NULL, TRUE);
        AddTextPrinterParameterizedWithRTL(WIN_DISPLAY_INFO, FONT_SMALL, sStorage->displayMonItemName, 6, 43, TEXT_SKIP_DRAW, NULL, TRUE);
    }
    else
    {
        AddTextPrinterParameterizedWithRTL(WIN_DISPLAY_INFO, FONT_SMALL, sStorage->displayMonItemName, 6, 0, TEXT_SKIP_DRAW, NULL, TRUE);
        AddTextPrinterParameterizedWithRTL(WIN_DISPLAY_INFO, FONT_NORMAL, sStorage->displayMonNameText, 6, 13, TEXT_SKIP_DRAW, NULL, TRUE);
        AddTextPrinterParameterizedWithRTL(WIN_DISPLAY_INFO, FONT_SHORT, sStorage->displayMonSpeciesName, 6, 28, TEXT_SKIP_DRAW, NULL, TRUE);
        AddTextPrinterParameterizedWithRTL(WIN_DISPLAY_INFO, FONT_SHORT, sStorage->displayMonGenderLvlText, 10, 42, TEXT_SKIP_DRAW, NULL, TRUE);
    }
...
static void PrintMessage(u8 id)
{
    ...
    AddTextPrinterParameterizedWithRTL(WIN_MESSAGE, FONT_NORMAL, sStorage->messageText, 0, 1, TEXT_SKIP_DRAW, NULL, TRUE);
...
static void PrintItemDescription(void)
{
    ...
    AddTextPrinterParameterized5WithRTL(WIN_ITEM_DESC, FONT_NORMAL, description, 4, 0, 0, NULL, 0, 1, TRUE);
}
