...
const u8 gEasyChatWord_Tuesday[] = _("שלישי");
const u8 gEasyChatWord_Yesterday[] = _("אתמול");
const u8 gEasyChatWord_Today[] = _("היום");
const u8 gEasyChatWord_Friday[] = _("שישי");
const u8 gEasyChatWord_Monday[] = _("שני");
...
const u8 gEasyChatWord_Wednesday[] = _("רביעי");
...
const u8 gEasyChatWord_Saturday[] = _("שבת");
const u8 gEasyChatWord_Summer[] = _("קיץ");
const u8 gEasyChatWord_Sunday[] = _("ראשון");
...
const u8 gEasyChatWord_Thursday[] = _("חמישי");
