...
const u8 gEasyChatWord_Stench[] = _("צחנה");
const u8 gEasyChatWord_ThickFat[] = _("שומן עבה");
const u8 gEasyChatWord_RainDish[] = _("מנת גשם");
const u8 gEasyChatWord_Drizzle[] = _("טפטוף");
const u8 gEasyChatWord_ArenaTrap[] = _("מלכודת זירה");
const u8 gEasyChatWord_Intimidate[] = _("איום");
const u8 gEasyChatWord_RockHead[] = _("ראש אבן");
const u8 gEasyChatWord_Color[] = _("צבע");
const u8 gEasyChatWord_AltColor[] = _("צבע חלופי");
const u8 gEasyChatWord_Rock[] = _("סלע");
const u8 gEasyChatWord_Beautiful[] = _("יפה");
const u8 gEasyChatWord_Beauty[] = _("יופי");
const u8 gEasyChatWord_AirLock[] = _("נעילת אוויר");
const u8 gEasyChatWord_Psychic[] = _("על-חושי");
const u8 gEasyChatWord_HyperCutter[] = _("חותך-על");
const u8 gEasyChatWord_Fighting[] = _("לחימה");
const u8 gEasyChatWord_ShadowTag[] = _("תג צל");
const u8 gEasyChatWord_Smart[] = _("חכם");
const u8 gEasyChatWord_Smartness[] = _("חוכמה");
const u8 gEasyChatWord_SpeedBoost[] = _("האצת מהירות");
const u8 gEasyChatWord_Cool[] = _("מגניב");
const u8 gEasyChatWord_Coolness[] = _("מגניבות");
const u8 gEasyChatWord_BattleArmor[] = _("שריון קרב");
const u8 gEasyChatWord_Cute[] = _("חמוד");
const u8 gEasyChatWord_Cuteness[] = _("חמידות");
const u8 gEasyChatWord_Sturdy[] = _("יציב");
const u8 gEasyChatWord_SuctionCups[] = _("כוסות יניקה");
const u8 gEasyChatWord_Grass[] = _("עשב");
const u8 gEasyChatWord_ClearBody[] = _("גוף שקוף");
const u8 gEasyChatWord_Torrent[] = _("שטף");
const u8 gEasyChatWord_Ghost[] = _("רוח");
const u8 gEasyChatWord_Ice[] = _("קרח");
const u8 gEasyChatWord_Guts[] = _("אומץ");
const u8 gEasyChatWord_RoughSkin[] = _("עור מחוספס");
const u8 gEasyChatWord_ShellArmor[] = _("שריון קונכייה");
const u8 gEasyChatWord_NaturalCure[] = _("ריפוי טבעי");
const u8 gEasyChatWord_Damp[] = _("לחות");
const u8 gEasyChatWord_Ground[] = _("אדמה");
const u8 gEasyChatWord_Limber[] = _("גמיש");
const u8 gEasyChatWord_MagnetPull[] = _("משיכת מגנט");
const u8 gEasyChatWord_WhiteSmoke[] = _("עשן לבן");
const u8 gEasyChatWord_Synchronize[] = _("תיאום");
const u8 gEasyChatWord_Overgrow[] = _("צמיחת יתר");
const u8 gEasyChatWord_SwiftSwim[] = _("שחייה זריזה");
const u8 gEasyChatWord_SandStream[] = _("זרם חול");
const u8 gEasyChatWord_SandVeil[] = _("מעטה חול");
const u8 gEasyChatWord_KeenEye[] = _("עין חדה");
const u8 gEasyChatWord_InnerFocus[] = _("ריכוז פנימי");
const u8 gEasyChatWord_Static[] = _("סטטי");
const u8 gEasyChatWord_Type[] = _("סוג");
const u8 gEasyChatWord_Tough[] = _("קשוח");
const u8 gEasyChatWord_Toughness[] = _("קשיחות");
const u8 gEasyChatWord_ShedSkin[] = _("השלת עור");
const u8 gEasyChatWord_HugePower[] = _("עוצמה ענקית");
const u8 gEasyChatWord_VoltAbsorb[] = _("ספיגת חשמל");
const u8 gEasyChatWord_WaterAbsorb[] = _("ספיגת מים");
const u8 gEasyChatWord_Electric[] = _("חשמל");
const u8 gEasyChatWord_Forecast[] = _("תחזית");
const u8 gEasyChatWord_SereneGrace[] = _("שלוות חסד");
const u8 gEasyChatWord_Poison[] = _("רעל");
const u8 gEasyChatWord_PoisonPoint[] = _("נקודת רעל");
const u8 gEasyChatWord_Dragon[] = _("דרקון");
const u8 gEasyChatWord_Trace[] = _("עקיבה");
const u8 gEasyChatWord_Oblivious[] = _("חסר מודע");
const u8 gEasyChatWord_Truant[] = _("השתמטות");
const u8 gEasyChatWord_RunAway[] = _("בריחה");
const u8 gEasyChatWord_StickyHold[] = _("אחיזה דביקה");
const u8 gEasyChatWord_CloudNine[] = _("רקיע השביעי");
const u8 gEasyChatWord_Normal[] = _("רגיל");
const u8 gEasyChatWord_Steel[] = _("פלדה");
const u8 gEasyChatWord_Illuminate[] = _("הארה");
const u8 gEasyChatWord_EarlyBird[] = _("השכם בוקר");
const u8 gEasyChatWord_Hustle[] = _("המולה");
const u8 gEasyChatWord_Shine[] = _("ברק");
const u8 gEasyChatWord_Flying[] = _("מעופף");
const u8 gEasyChatWord_Drought[] = _("בצורת");
const u8 gEasyChatWord_Lightningrod[] = _("מוליך ברק");
const u8 gEasyChatWord_Compoundeyes[] = _("עיניים מורכבות");
const u8 gEasyChatWord_MarvelScale[] = _("קשקשי פלא");
const u8 gEasyChatWord_WonderGuard[] = _("הגנת פלא");
const u8 gEasyChatWord_Insomnia[] = _("נדודי שינה");
const u8 gEasyChatWord_Levitate[] = _("רחיפה");
const u8 gEasyChatWord_Plus[] = _("פלוס");
const u8 gEasyChatWord_Pressure[] = _("לחץ");
const u8 gEasyChatWord_LiquidOoze[] = _("רפש נוזלי");
const u8 gEasyChatWord_ColorChange[] = _("שינוי צבע");
const u8 gEasyChatWord_Soundproof[] = _("חסין קול");
const u8 gEasyChatWord_EffectSpore[] = _("נבג השפעה");
const u8 gEasyChatWord_Pkrs[] = _("פוקיוירוס");
const u8 gEasyChatWord_Fire[] = _("אש");
const u8 gEasyChatWord_FlameBody[] = _("גוף להבה");
const u8 gEasyChatWord_Minus[] = _("מינוס");
const u8 gEasyChatWord_OwnTempo[] = _("בקצב שלי");
const u8 gEasyChatWord_MagmaArmor[] = _("שריון מגמה");
const u8 gEasyChatWord_Water[] = _("מים");
const u8 gEasyChatWord_WaterVeil[] = _("מעטה מים");
const u8 gEasyChatWord_Bug[] = _("חרק");
const u8 gEasyChatWord_Swarm[] = _("נחיל");
const u8 gEasyChatWord_CuteCharm[] = _("חן מקסים");
const u8 gEasyChatWord_Immunity[] = _("חסינות");
const u8 gEasyChatWord_Blaze[] = _("להט");
const u8 gEasyChatWord_Pickup[] = _("איסוף");
const u8 gEasyChatWord_Pattern[] = _("תבנית");
const u8 gEasyChatWord_FlashFire[] = _("הבזק אש");
const u8 gEasyChatWord_VitalSpirit[] = _("רוח חיונית");
const u8 gEasyChatWord_Chlorophyll[] = _("כלורופיל");
const u8 gEasyChatWord_PurePower[] = _("כוח טהור");
const u8 gEasyChatWord_ShieldDust[] = _("אבק מגן");
