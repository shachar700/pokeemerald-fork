...
static u32 LoopedTask_PrintListItems(s32 state)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterizedWithRTL(listSub->listWindow.windowId, listSub->listWindow.fontId, listSub->itemTextBuffer, 8, (row << 4) + 1, TEXT_SKIP_DRAW, NULL, TRUE);
...
static void PrintCheckPageTrainerName(struct PokenavListWindowState *state, struct PokenavListSub *list)
{
    ...
    AddTextPrinterParameterized3WithRTL(list->listWindow.windowId, list->listWindow.fontId, 8, (list->listWindow.unkA * 16) + 1, colors, TEXT_SKIP_DRAW, list->itemTextBuffer, TRUE);
...
static void PrintMatchCallListTrainerName(struct PokenavListWindowState *state, struct PokenavListSub *list)
{
    ...
    AddTextPrinterParameterizedWithRTL(list->listWindow.windowId, list->listWindow.fontId, list->itemTextBuffer, 8, list->listWindow.unkA * 16 + 1, TEXT_SKIP_DRAW, NULL, TRUE);
...
static void PrintMatchCallFieldNames(struct PokenavListSub *list, u32 fieldId)
{
    ...
    AddTextPrinterParameterized3WithRTL(list->listWindow.windowId, FONT_NARROW, 2, (top << 4) + 1, colors, TEXT_SKIP_DRAW, fieldNames[fieldId], TRUE);
...
static void PrintMatchCallFlavorText(struct PokenavListWindowState *windowState, struct PokenavListSub *list, u32 checkPageEntry)
{
    ...
    if (str != NULL)
    {
        ...
        AddTextPrinterParameterizedWithRTL(list->listWindow.windowId, FONT_NARROW, str, 2, (r6 << 4) + 1, TEXT_SKIP_DRAW, NULL, TRUE);
