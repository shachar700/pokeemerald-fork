...
void PrintOnTrainerHillRecordsWindow(void)
{
    ...
    AddTextPrinterParameterized3WithRTL(0, FONT_NORMAL, x, 2, sRecordWinColors, TEXT_SKIP_DRAW, gText_TimeBoard, TRUE);

    y = 18;
    for (i = 0; i < NUM_TRAINER_HILL_MODES; i++)
    {
        AddTextPrinterParameterized3WithRTL(0, FONT_NORMAL, 0, y, sRecordWinColors, TEXT_SKIP_DRAW, sModeStrings[i], TRUE);
        y += 15;
