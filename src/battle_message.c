...
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} צבר{B_BUFF2}\n{B_BUFF3} נק' ניסיון!\p");
static const u8 sText_EmptyString4[] = _("");
static const u8 sText_ABoosted[] = _(" מוגבר");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} גדל\nלרמה {B_BUFF2}!{WAIT_SE}\p");
...
static const u8 sText_StopLearningMove[] = _("{PAUSE 32}הפסיק ללמוד\n{B_BUFF2}?");
...
static const u8 sText_PlayerGotMoney[] = _("{B_PLAYER_NAME} השיג {B_BUFF1}¥\nעבור ניצחון!\p");
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} בלי פוקימון\nפעיל!\p");
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} איבד הכרה!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_PkmnLaidCurse[] = _("{B_ATK_NAME_WITH_PREFIX} קיצץ את נ”ח שלו\nוהטיל קללה על {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnCutHPMaxedAttack[] = _("{B_ATK_NAME_WITH_PREFIX} קיצץ את נ”ח שלו\nומקסם התקפה!");
...
static const u8 sText_PkmnRestoredHPUsing[] = _("{B_DEF_NAME_WITH_PREFIX} החזיר נ”ח\nבעזרת {B_DEF_ABILITY}!");
...
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}נמלט בשלום!\p");
...
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} נמלט!");
...
static const u8 sText_PkmnBeganToNap[] = _("{B_ATK_NAME_WITH_PREFIX} התחיל לנמנם!");
static const u8 sText_PkmnLoafing[] = _("{B_ATK_NAME_WITH_PREFIX}\nמתבטל!");
static const u8 sText_PkmnWontObey[] = _("{B_ATK_NAME_WITH_PREFIX} לא\nמציית!");
static const u8 sText_PkmnTurnedAway[] = _("{B_ATK_NAME_WITH_PREFIX} הסתובב!");
static const u8 sText_PkmnPretendNotNotice[] = _("{B_ATK_NAME_WITH_PREFIX} העמיד פנים\nשלא שם לב!");
...
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("שחקן הביס את\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!\p");
static const u8 sText_CreptCloser[] = _("{B_PLAYER_NAME} התקרב יותר\nל{B_OPPONENT_MON1_NAME}!");
static const u8 sText_CantGetCloser[] = _("{B_PLAYER_NAME} לא יכול להתקרב יותר!");
...
static const u8 sText_ThrewPokeblockAtPkmn[] = _("{B_PLAYER_NAME} זרק {POKEBLOCK}\nאל {B_OPPONENT_MON1_NAME}!");
...
const u8 gText_PkmnIsEvolving[] = _("מה?\n{STR_VAR_1} בתהליך התפתחות!");
const u8 gText_CongratsPkmnEvolved[] = _("מזל טוב! ההתפתחות של {STR_VAR_1}\nשלך הפכה ל{STR_VAR_2}!{WAIT_SE}\p");
const u8 gText_PkmnStoppedEvolving[] = _("הא? ההתפתחות של\n{STR_VAR_1} הפסיקה!\p");
...
static const u8 sText_QuestionForfeitMatch[] = _("האם לפרוש מהקרב\nולצאת עכשיו?");
static const u8 sText_ForfeitedMatch[] = _("{B_PLAYER_NAME} פרש מהקרב!");
static const u8 sText_Trainer1WinText[] = _("{B_TRAINER1_WIN_TEXT}");
static const u8 sText_Trainer2WinText[] = _("{B_TRAINER2_WIN_TEXT}");
static const u8 sText_Trainer1Fled[] = _( "{PLAY_SE SE_FLEE}{B_TRAINER1_CLASS} {B_TRAINER1_NAME} נמלט!");
...
const u8 gText_RecordBattleToPass[] = _("האם להקליט את הקרב שלך\nעל הכרטיס פרונטיר שלך?");
