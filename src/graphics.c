...
const u32 gNamingScreenPageSwapHeb_Gfx[]         = INCGFX_U32("graphics/naming_screen/page_swap_heb.png", ".4bpp");
...
const u32 gNamingScreenKeyboardHeb_Tilemap[]     = INCGFX_U32("graphics/naming_screen/keyboard_heb.bin", ".lz");
