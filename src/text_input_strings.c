...
const u8 gText_NamingScreenKeyboard_zain2lamed[] = _("{CLEAR 11}ל{CLEAR 6}ך{CLEAR 7}כ{CLEAR 8}י{CLEAR 27}ט{CLEAR 6}ח{CLEAR 7}ז{CLEAR 6} {CLEAR 16},");
const u8 gText_NamingScreenKeyboard_mem2pey[] = _("{CLEAR 11}ף{CLEAR 6}פ{CLEAR 6}ע{CLEAR 6}ס{CLEAR 15}ן{CLEAR 9}נ{CLEAR 7}ם{CLEAR 6}מ{CLEAR 9} {CLEAR 16} ");
const u8 gText_NamingScreenKeyboard_tzadik2taf[] = _("{CLEAR 23}ת{CLEAR 5}ש{CLEAR 6}ר{CLEAR 26}ק{CLEAR 6}ץ{CLEAR 6}צ{CLEAR 8} {CLEAR 16} ");
