...
const u8 gText_NamingScreenKeyboard_GHIJKL[] = _("{CLEAR 3},            L  K  J         I  H  G");
const u8 gText_NamingScreenKeyboard_MNOPQRS[] = _("{CLEAR 3}         S  R  Q  P         O  N  M");
const u8 gText_NamingScreenKeyboard_TUVWXYZ[] = _("{CLEAR 3}         Z  Y  X  W         V  U  T");
const u8 gText_NamingScreenKeyboard_01234[] = _("           4      3     2      1     0");
const u8 gText_NamingScreenKeyboard_56789[] = _("           9      8     7      6     5");
const u8 gText_NamingScreenKeyboard_Symbols1[] = _("    -     /      ♀     ♂      ?     !");
const u8 gText_NamingScreenKeyboard_Symbols2[] = _("            '      ‘      ”      “     …");
...
const u8 gText_UnionRoomChatKeyboard_uvwxy[] = _("שתךםן");
const u8 gText_UnionRoomChatKeyboard_z[] = _("ףץ  ");
