...
const u8 gText_NamingScreenKeyboard_abcdef[] = _("{CLEAR 8}.   והד{CLEAR 2}{CLEAR 2}{CLEAR 2}{CLEAR 2} ג{CLEAR 2}ב{CLEAR 2}א");
const u8 gText_NamingScreenKeyboard_ghijkl[] = _("{CLEAR 6},   {CLEAR 6}{CLEAR 6}ל{CLEAR 6}כ{CLEAR 6}ע {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ט{CLEAR 6}ח{CLEAR 6}ז");
const u8 gText_NamingScreenKeyboard_mnopqrs[] = _("{CLEAR 6}{CLEAR 6}{CLEAR 6}ק{CLEAR 6}צ{CLEAR 6}פ{CLEAR 6}ע {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ס{CLEAR 6}נ{CLEAR 6}מ ");
const u8 gText_NamingScreenKeyboard_tuvwxyz[] = _("{CLEAR 6}ץ{CLEAR 6}ף{CLEAR 6}ן{CLEAR 6}ם{CLEAR 6}ך {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}ת{CLEAR 6}ש{CLEAR 6}ר ");
const u8 gText_NamingScreenKeyboard_ABCDEF[] = _("{CLEAR 8}.   {CLEAR 6}{CLEAR 6}F{CLEAR 6}E{CLEAR 6}D {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}C{CLEAR 6}B{CLEAR 6}A");
const u8 gText_NamingScreenKeyboard_GHIJKL[] = _("{CLEAR 6},   {CLEAR 6}{CLEAR 6}L{CLEAR 6}K{CLEAR 6}J {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}I{CLEAR 6}H{CLEAR 6}G");
const u8 gText_NamingScreenKeyboard_MNOPQRS[] = _("{CLEAR 6}{CLEAR 6}{CLEAR 6}S{CLEAR 6}R{CLEAR 6}Q{CLEAR 6}P {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}O{CLEAR 6}N{CLEAR 6}M ");
const u8 gText_NamingScreenKeyboard_TUVWXYZ[] = _("{CLEAR 6}{CLEAR 6}{CLEAR 6}Z{CLEAR 6}Y{CLEAR 6}X{CLEAR 6}W {CLEAR 6}{CLEAR 6}{CLEAR 6}{CLEAR 6}V{CLEAR 6}U{CLEAR 6}T ");
