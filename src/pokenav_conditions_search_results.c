...
static void PrintSearchResultListMenuItems(struct Pokenav_SearchResultsGfx *gfx)
{
    ...
    *gStringVar1 = EOS;
    ...
    AddTextPrinterParameterizedWithRTL(gfx->winid, FONT_NORMAL, gStringVar2, 4, 1, TEXT_SKIP_DRAW, NULL, TRUE);
    ConvertIntToDecimalStringN(gStringVar1, rank, STR_CONV_MODE_RIGHT_ALIGN, 3);
    AddTextPrinterParameterizedWithRTL(gfx->winid, FONT_NORMAL, gStringVar1, 34, 1, TEXT_SKIP_DRAW, NULL, TRUE);
