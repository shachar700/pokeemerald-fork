...
const u8 gText_Option[] = _("אפשרות");
...
const u8 gText_ButtonMode[] = _("מצב כפתור");
...
const u8 gText_BattleSceneOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}דולק");
...
const u8 gText_MenuPokedex[] = _("פוקידקס");
...
const u8 gText_MenuOption[] = _("אופציות");
