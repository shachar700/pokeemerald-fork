...
static void CreatePCMultichoice(void)
{
    ...
    if (FlagGet(FLAG_SYS_GAME_CLEAR))
    {
        ...
        SetStandardWindowBorderStyle(windowId, FALSE);
        AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_HallOfFame, x, 33, TEXT_SKIP_DRAW, NULL, TRUE);
        AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_LogOff, x, 49, TEXT_SKIP_DRAW, NULL, TRUE);
    }
    else
    {
        numChoices = 3;
        ...
        SetStandardWindowBorderStyle(windowId, FALSE);
        AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_LogOff, x, 33, TEXT_SKIP_DRAW, NULL, TRUE);
    }

    // Change PC name if player has met Lanette
    if (FlagGet(FLAG_SYS_PC_LANETTE))
        AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_LanettesPC, x, 1, TEXT_SKIP_DRAW, NULL, TRUE);
    else
        AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_SomeonesPC, x, 1, TEXT_SKIP_DRAW, NULL, TRUE);
...
static void CreateLilycoveSSTidalMultichoice(void)
{
    ...
    else
    {
        ...
        for (selectionCount = 0, i = 0; i < SSTIDAL_SELECTION_COUNT; i++)
        {
            ...
            {
                AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, sLilycoveSSTidalDestinations[sLilycoveSSTidalSelections[i]], 8, selectionCount * 16 + 1, TEXT_SKIP_DRAW, NULL, TRUE);
                selectionCount++;
            }
        }
...
static void CreateStartMenuForPokenavTutorial(void)
{
    ...
    SetStandardWindowBorderStyle(windowId, FALSE);
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_MenuOptionPokedex, 8, 9, TEXT_SKIP_DRAW, NULL, TRUE);
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_MenuOptionPokemon, 8, 25, TEXT_SKIP_DRAW, NULL, TRUE);
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_MenuOptionBag, 8, 41, TEXT_SKIP_DRAW, NULL, TRUE);
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_MenuOptionPokenav, 8, 57, TEXT_SKIP_DRAW, NULL, TRUE);
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gSaveBlock2Ptr->playerName, 8, 73, TEXT_SKIP_DRAW, NULL, TRUE);
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_MenuOptionSave, 8, 89, TEXT_SKIP_DRAW, NULL, TRUE);
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_MenuOptionOption, 8, 105, TEXT_SKIP_DRAW, NULL, TRUE);
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_MenuOptionExit, 8, 121, TEXT_SKIP_DRAW, NULL, TRUE);
