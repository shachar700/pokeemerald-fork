...
static void Msg_WantToPlayAgain(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterizedWithRTL(sPokemonJumpGfx->msgWindowId, FONT_NORMAL, gText_WantToPlayAgain2, 0, 1, TEXT_SKIP_DRAW, NULL, TRUE);
...
static void Msg_SavingDontTurnOff(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterizedWithRTL(sPokemonJumpGfx->msgWindowId, FONT_NORMAL, gText_SavingDontTurnOffPower, 0, 1, TEXT_SKIP_DRAW, NULL, TRUE);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void Msg_SomeoneDroppedOut(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterizedWithRTL(sPokemonJumpGfx->msgWindowId, FONT_NORMAL, gText_SomeoneDroppedOut2, 0, 1, TEXT_SKIP_DRAW, NULL, TRUE);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void Msg_CommunicationStandby(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterizedWithRTL(sPokemonJumpGfx->msgWindowId, FONT_NORMAL, gText_CommunicationStandby4, 0, 1, TEXT_SKIP_DRAW, NULL, TRUE);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void PrintPrizeMessage(u16 itemId, u16 quantity)
{
    ...
    AddTextPrinterParameterizedWithRTL(sPokemonJumpGfx->msgWindowId, FONT_NORMAL, sPokemonJumpGfx->prizeMsg, 0, 1, TEXT_SKIP_DRAW, NULL, TRUE);
    CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
...
static void PrintScoreSuffixes(void)
{
    ...
    AddTextPrinterParameterized3WithRTL(WIN_POINTS, FONT_SMALL, 0, 1, color, 0, gText_SpacePoints2, TRUE);
    AddTextPrinterParameterized3WithRTL(WIN_TIMES, FONT_SMALL, 0, 1, color, 0, gText_SpaceTimes3, TRUE);
}
...
static void PrintPokeJumpPlayerName(int multiplayerId, u8 bgColor, u8 fgColor, u8 shadow)
{
    ...
    x /= 2;
    AddTextPrinterParameterized3WithRTL(sPokemonJumpGfx->nameWindowIds[multiplayerId], FONT_NORMAL, x, 1, colors, TEXT_SKIP_DRAW, GetPokeJumpPlayerName(multiplayerId), TRUE);
...
static void PrintRecordsText(u16 windowId, int width)
{
    ...
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_PkmnJumpRecords, GetStringCenterAlignXOffset(FONT_NORMAL, gText_PkmnJumpRecords, width * 8), 1, TEXT_SKIP_DRAW, NULL, TRUE);
    for (i = 0; i < ARRAY_COUNT(sRecordsTexts); i++)
    {
        AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, sRecordsTexts[i], 0, 25 + (i * 16), TEXT_SKIP_DRAW, NULL, TRUE);
        ...
        AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gStringVar1, x, 25 + (i * 16), TEXT_SKIP_DRAW, NULL, TRUE);
    }
