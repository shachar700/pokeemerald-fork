...
static void PrintTime(u8 windowId, u8 x, u8 y, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gStringVar4, x, y, TEXT_SKIP_DRAW, NULL, TRUE);
}
...
static void ShowChooseTimeWindow(u8 windowId, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_Confirm2, 126, 1, 0, NULL, TRUE);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void ShowMessage(const u8 *str)
{
    ...
    AddTextPrinterParameterizedWithRTL(WIN_MSG, FONT_NORMAL, str, 0, 1, 0, NULL, TRUE);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void Task_ShowResetRtcPrompt(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterizedWithRTL(WIN_TIME, FONT_NORMAL, gText_PresentTime, 0, 1, TEXT_SKIP_DRAW, 0, TRUE);
        PrintTime(
            WIN_TIME,
            0,
            17,
        ...
        AddTextPrinterParameterizedWithRTL(WIN_TIME, FONT_NORMAL, gText_PreviousTime, 0, 33, TEXT_SKIP_DRAW, 0, TRUE);
        PrintTime(
            WIN_TIME,
            0,
            49,
