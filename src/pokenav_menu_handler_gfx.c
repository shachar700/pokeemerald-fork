...
static void PrintCurrentOptionDescription(void)
{
    ...
    FillWindowPixelBuffer(gfx->optionDescWindowId, PIXEL_FILL(6));
    AddTextPrinterParameterized3WithRTL(gfx->optionDescWindowId, FONT_NORMAL, (192 - width) / 2, 1, sOptionDescTextColors, 0, desc, TRUE);
}
...
static void PrintNoRibbonWinners(void)
{
    ...
    FillWindowPixelBuffer(gfx->optionDescWindowId, PIXEL_FILL(6));
    AddTextPrinterParameterized3WithRTL(gfx->optionDescWindowId, FONT_NORMAL, (192 - width) / 2, 1, sOptionDescTextColors2, 0, s, TRUE);
}
