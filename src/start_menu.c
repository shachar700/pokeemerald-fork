...
static bool32 PrintStartMenuActions(s8 *pIndex, u32 count)
{
    ...
    do
    {
        ...
        {
            PrintPlayerNameOnWindow(GetStartMenuWindowId(), sStartMenuItems[sCurrentStartMenuActions[index]].text, 42, (index << 4) + 9); // pos of name in start menu
        }
        else
        {
            StringExpandPlaceholders(gStringVar4, sStartMenuItems[sCurrentStartMenuActions[index]].text);
            AddTextPrinterParameterized(GetStartMenuWindowId(), FONT_NORMAL, gStringVar4, 42, (index << 4) + 9, TEXT_SKIP_DRAW, NULL); // pos of options in start menu
        }
...
static bool32 InitStartMenuStep(void)
{
    ...
    case 4:
        ...
        break;
    case 5:
        sStartMenuCursorPos = InitMenuNormal(GetStartMenuWindowId(), FONT_NORMAL, /* 0 x pos of arrow in start menu */ 18, 9, 16, sNumStartMenuActions, sStartMenuCursorPos); 
