...
u8 GetTimeOfDay(void)
{
    ...
    else if (IsBetweenHours(hour, EARLY_MORNING_HOUR_BEGIN, EARLY_MORNING_HOUR_END))
    ...
    else if (IsBetweenHours(hour, NOONTIME_HOUR_BEGIN, NOONTIME_HOUR_END))
        return TIME_NOONTIME;
    else if (IsBetweenHours(hour, EVENING_HOUR_BEGIN, EVENING_HOUR_END))
        return TIME_EVENING;
    else if (IsBetweenHours(hour, NIGHTTIME_HOUR_BEGIN, NIGHTTIME_HOUR_END))
        return TIME_NIGHTTIME;
    return NULL;
}
