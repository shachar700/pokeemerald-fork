...
static void PrintBerryPowderAmount(u8 windowId, int amount, u8 x, u8 y, u8 speed)
{
    ...
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gStringVar1, x, y, speed, NULL, TRUE);
}
...
static void DrawPlayerPowderAmount(u8 windowId, u16 baseTileOffset, u8 paletteNum, u32 amount)
{
    ...
    AddTextPrinterParameterizedWithRTL(windowId, FONT_NORMAL, gText_Powder, 0, 1, TEXT_SKIP_DRAW, NULL, TRUE);
